...
<body>
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide2">
                    <div class="main_descrip">
                        <h1>Read More</h1>
                        <p>Thousands of Books Available at Your Fingertips</p>
    ...
    <section class="about_cont">
        ...
        <div class="about_descript">
            ...
            <p>At Novel Nest, we are passionate about connecting readers with captivating stories, inspiring ideas, and a
                world of knowledge. Our bookstore is more than just a place to buy books; it's a haven for book
                enthusiasts, where the love for literature thrives.
            </p>
    ...
    <section class="questions_cont">
        <div class="questions">
            ...
            <p>At Bookiee, we value your satisfaction and strive to provide exceptional customer service. If you have
                any questions, concerns, or inquiries, our dedicated team is here to assist you every step of the way.
            </p>
